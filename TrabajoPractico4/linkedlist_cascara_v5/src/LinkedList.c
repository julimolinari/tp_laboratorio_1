...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    //resolver problema de ir saltando del uno al otro
    Node* pNode = NULL;
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this!= NULL && this2 !=NULL)
    {
        ...
        for(i=0; i< this2->size ; i++)
        {
            ...
            if(auxNode2 != NULL)
            {
                if(ll_contains(this,auxNode2->pElement)!= 1)
                {
                    returnAux = 0;
                    break;
                }
    ...
    if(this != NULL  && pFunc!=NULL && (order==0 || order==1))
    {
        while(flag)
        {
            ...
            for(i=0; i<len-1; i++)
            {
                ...
                if(((pFunc(auxA,auxB)>0) && order == 1) || ((pFunc(auxA,auxB)<0) && order == 0))
                {
                    flag= 1;
                    ll_set(this,i,auxB);
